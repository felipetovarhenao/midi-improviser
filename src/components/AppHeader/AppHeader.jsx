...
export default function AppHeader() {
  return (
    <div className="AppHeader">
      ...
      <div>
        <p>
          <b>MIDI improviser</b> is a web application that automatically generates polyphonic music as a MIDI file, based on one or more MIDI input files provided by the user. The degree of freedom
